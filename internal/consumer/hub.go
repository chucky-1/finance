...
var welcomeMessage = "Привет! Если вы хотите лучше контролировать свои расходы, я могу вам помочь! Каждый раз, когда вы тратите деньги, " +
	"просто отправляйте мне сообщение со статьёй расходов и суммой.\n\n" +
